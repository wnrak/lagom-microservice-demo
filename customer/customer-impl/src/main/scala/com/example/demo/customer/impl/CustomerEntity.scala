...
/**
  * This is an event sourced entity. It has a state, [[CustomerState]], which
...
class CustomerEntity extends PersistentEntity {
  ...
  /**
    ...
    */
  override def initialState: CustomerState = CustomerState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case CustomerState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        CustomerState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class CustomerState(message: String, timestamp: String)
...
/**
  * This interface defines all the events that the CustomerEntity supports.
  */
...
/**
  ...
  */
case class GreetingMessageChanged(message: String) extends CustomerEvent
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends CustomerCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends CustomerCommand[String]
